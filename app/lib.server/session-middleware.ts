/**
 * modified from remix-utils to support rsc
 * @see https://github.com/sergiodxa/remix-utils/blob/70c1cf0be6b00c657d8105ceb18520e4da341900/src/server/middleware/session.ts
 */
...
import { unstable_createContext } from "react-router/rsc";
import type { unstable_RouterContextProvider } from "react-router/rsc";
